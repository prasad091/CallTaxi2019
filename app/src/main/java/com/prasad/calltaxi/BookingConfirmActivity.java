...
public class BookingConfirmActivity extends AppCompatActivity implements OnMapReadyCallback {

    @BindView(R.id.standard)
    AppCompatImageView standard;

    @BindView(R.id.nonstandard)
    AppCompatImageView nonstandard;
    ...
    protected void onCreate(@Nullable Bundle savedInstanceState) {
        ...
        nonstandard.setColorFilter(filter);
    }
    ...
    public void booking(){
        Intent intent = new Intent(this,SuccessBookingActivity.class);
